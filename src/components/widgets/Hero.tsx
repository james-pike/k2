...
<section class="relative rounded-md not-prose mx-1.5 my-1.5 bg-white/90 dark:bg-gray-900/90">
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div class="py-8 md:py-20 lg:py-0 lg:flex lg:items-center lg:h-screen lg:gap-8">
          ...
          <a href="https://dapp.chainge.finance/?fromChain=KAS&toChain=KAS&fromToken=KAS&toToken=KOIN_krc20" class="inline-flex justify-between items-center py-1 px-1 pr-4 mb-5 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
                <span class="text-xs bg-primary rounded-full text-white px-4 py-1.5 mr-3">New</span> <span class="text-sm font-medium">KOIN now live on Chainge!</span>
